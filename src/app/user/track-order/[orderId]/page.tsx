                    ...
                    <div className='bg-white rounded-3xl shadow-lg border p-4 h-[430px] flex flex-col'>
                        ...
                        <div className='flex justify-between items-center mb-3'>
                            ...
                            <motion.button
                                whileTap={{ scale: 0.9 }}
                                disabled={loading}
                                className='px-3 py-1 flex items-center gap-1 bg-purple-100 text-purple-700
                                        rounded-full shadow-sm border border-purple-200'onClick={getSuggestion}>
                            ...
                            <AnimatePresence>
                                {messages?.map((msg, index) => (
                                    <motion.div
                                        ...
                                        key={msg._id ? msg._id.toString() : `temp-${index}`}
                                    ...
                                    >
                                        <div className={`px-4 py-2 max-w-[75%] rounded-2xl shadow
                                                ...
                                                : "bg-gray-100 text-gray-800 rounded-bl-none"
                                                    ...
                                                    `}>
                                            <p >{msg.text}</p>
                                            <p className='text-[13px] opacity-70 mt-1 text-right'>{msg.time}</p>
                                        </div>
                        ...
                        <div className='flex gap-2 mt-3 border-t pt-3'>
                            ...
                            <button className='bg-green-600 hover:bg-green-700 p-3 rounded-xl text-white'
                                onClick={sendMsg}><Send size={18} /></button>
                        </div>
