        ...
        <div className='flex flex-col items-center justify-center min-h-screen px-6 text-center bg-linear-to-b from-green-50 to-white '>
            <motion.div
                ...
                <motion.div
                    ...
                    animate={{ opacity: [0, 0.3, 0, 0.3], scale: [1, 0.6, 1] }}
                    transition={{
                        repeat: Infinity,
                        duration: 2,
                        ease: "easeInOut"
            ...
            <motion.div
                ...
                className='mt-10'>
                <Package className='w-16 h-16 md:w-20 md:h-10 text-green-500' />
            </motion.div>
            <motion.div
                ...
                <Link href={"/user/my-orders"}>
                    <motion.div
                        ...
                        whileTap={{ scale: 0.93 }} className='flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-base font-semibold px-8 py-3 rounded-full 
                    shadow-lg transition-all '>
                        Go to My Orders Page<ArrowRight /></motion.div>
                </Link>
            </motion.div>
            <motion.div
                initial={{ opacity: 0 }}
                ...
                <div className='absolute top-16 left-710%] w-2 h-2 bg-green-400 rounded-full animate-pulse' />
            </motion.div>
        </div>
    )
}
