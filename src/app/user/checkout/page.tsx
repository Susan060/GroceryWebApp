...
import { input, object } from 'motion/react-client'
...
function Checkout() {
    ...
    const handleCurrentLocation = () => {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition((pos) => {
                const { latitude, longitude } = pos.coords
                setPosition([latitude, longitude])
            }, (err) => { console.log('location error', err) }, { enableHighAccuracy: true, maximumAge: 0, timeout: 60000 })
        }
    ...
    return (
        ...
        text-green-700 hover:text-green-800 font-semiboold'onClick={() => router.push("/user/cart")}>
                <ArrowLeft size={16} />
            ...
            <div className='grid md:grid-cols-2 gap-8'>
                ...
                p-6 border-gray-100'>
                    <h2 className='text-xl font-semibold text-gray-800 mb-4 flec items-center gap-2'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <div className='relative mt-6 h-[250px] rounded-xl overflow-hidden border border-gray-200 shadow-inner'>
                            ...
                            <motion.button
                                whileTap={{ scale: 0.93 }}
                                className='absolute bottom-4 right-4 bg-green-600 text-white shadow-lg rounded-full p-3 hover:bg-green-700 transition-all flex items-center
                            justify-center z-999' onClick={handleCurrentLocation}>
                                <LocateFixed size={22} />
                            </motion.button>
