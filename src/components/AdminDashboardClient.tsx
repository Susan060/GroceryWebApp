...
function AdminDashboardClient({ earning, stats, chartData }: PropType) {
    ...
    return (
        <div className='pt-28 w-[90%] md:w-[80%] mx-auto'>
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mmb-10 text-center sm:text-left'>
                <motion.h1
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className='text-3xl  md:text-4xl font-bold text-green-700 mb-10'
                >🏪 Admin DashBoard</motion.h1>
                <select className='border border-gray-300 rounded-lg px-4 py-2 text:sm focus:ring-2 focus:ring-green-500 outline-none
            ...
            >
                ...
                <p className='text-4xl font-extrabold text-green-800'>रु{currentEarning.toLocaleString()}</p>
