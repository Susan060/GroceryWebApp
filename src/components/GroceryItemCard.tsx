    ...
    return (
        ...
        border border-gray-100 flex flex-col'>
            ...
            <div className='p-4 flex flex-col flex-1'>
                ...
                <motion.div className='mt-4 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700
                text-white rounded-full py-2 text-sm font-medium transition-all' whileTap={{scale:0.96}}>
