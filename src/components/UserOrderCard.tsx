...
function UserOrderCard({ order }: { order: IOrder }) {
    ...
    return (
        <motion.div
            ...
            transition={{ duration: 0.4 }} className='bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden'>
      ...
      border-b border-gray-100 px-5 py-4 bg-linear-to-r from-green-50 to-white'>
            ...
            <div className='p-5 space-y-4'>
                ...
                </div> : <div className='flex items-center text-gray-700 text-sm gap-2' >
                ...
                rounded-xl shadow hover:bg-green-700 transition'><Truck size={18} /> Track Your Order</button></>}
